...
struct Vertex {
    ...
    @location(4) i_base_color: vec4<f32>,
    @location(5) i_emissive_color: vec4<f32>,
...
fn fragment(in: VertexOutput, @builtin(front_facing) is_front: bool) -> @location(0) vec4<f32> {
    ...
    if firework_uniform.pbr == 0u {
        ...
        return pbr_stuff(color, emissive_color, in.position, in.world_position, in.world_normal, in.uv, in.world_tangent, is_front);
    }
}
